  ...
  "2022-2026": {
    ...
    3: [
      ...
      { sem: 3, code: "CW3301", name: "Fundamentals of Economics", credits: 3 },
      {
        sem: 3,
        code: "CW3311",
        name: "Business Communication Laboratory I",
        credits: 1.5,
      },
    ...
    4: [
      ...
      },
      {
        sem: 4,
        code: "CW3401",
        name: "Introduction to Business Systems",
        credits: 3,
      },
      {
        sem: 4,
        code: "CW3411",
        name: "Business Communication Laboratory II",
        credits: 1.5,
      },
      {
        sem: 4,
  ...
  "2023-2027": {
    1: [
      ...
      { sem: 1, code: "PUCC1HM02", name: "Heritage of Tamil", credits: 1 },
      {
        sem: 1,
        code: "PUCC1PL01",
        name: "Professional English - I(Lab)",
        credits: 2,
      },
      {
        sem: 1,
    ...
    2: [
      ...
      },
      {
        sem: 2,
        code: "PUCC2BE03",
        name: "Introduction to Computer Science & Business Systems",
        credits: 3,
      },
      {
        sem: 2,
      ...
      },
      {
        sem: 2,
        code: "PUCC2PL03",
        name: "Professional English - II(Lab)",
        credits: 2,
      },
      {
        sem: 2,
        code: "PUCC2PL04",
        name: "Problem Solving using Python Programming Laboratory",
        credits: 2,
      },
      {
        sem: 2,
        code: "PUCC2PL05",
        name: "Civil and Mechanical Engineering Practices",
        credits: 1,
      },
      {
        sem: 2,
        code: "PUCC2PL06",
        name: "Electrical and Electronics Engineering Preactices",
        credits: 1,
      },
    ...
    3: [
      ...
      },
      {
        sem: 3,
        code: "PUCC3MCXX",
        name: "Mandatory Course-I(Non-credit)",
        credits: 0,
      },
      {
        sem: 3,
        code: "PUAD3PL02",
        name: "Data Structures and Algorithms Laboratory I",
        credits: 2,
      },
      {
        sem: 3,
        code: "PUCS3PL02",
        name: "Object-Oriented Programmin Laboratory",
        credits: 2,
      },
      {
        sem: 3,
        code: "PUCB3PL01",
        name: "Business Communication Laboratory",
        credits: 1,
      },
